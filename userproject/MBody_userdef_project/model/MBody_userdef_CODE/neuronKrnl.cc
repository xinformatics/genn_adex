...
#ifndef _MBody_userdef_neuronKrnl_cc
#define _MBody_userdef_neuronKrnl_cc
...
extern "C" __global__ void calcNeurons(uint64_t * ratesPN, unsigned int offsetPN, float t)
 {
